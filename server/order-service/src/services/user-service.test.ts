...
describe('user-service', () => {
  ...
  describe('getOrderByUserId', () => {
    ...
    it('should handle database errors', async () => {
      ...
      await expect(getOrderByUserId('order123', 'user456')).rejects.toThrow('Failed to fetch order.');
    });
  });
  ...
  describe('getNameEmailItemQuantity', () => {
    ...
    it('should handle database errors', async () => {
      ...
      await expect(getNameEmailItemQuantity('user456', 'order123')).rejects.toThrow('Failed to fetch order and user data.');
    });
  });
});
