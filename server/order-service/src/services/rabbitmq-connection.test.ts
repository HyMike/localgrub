...
describe('RabbitMQConnection', () => {
  ...
  describe('getConnection', () => {
    ...
    it('should handle connection errors', async () => {
      ...
      await expect(rabbitMQ.getConnection()).rejects.toThrow('Connection failed');
    });
  ...
  describe('getChannel', () => {
    ...
    it('should handle channel creation errors', async () => {
      ...
      await expect(rabbitMQ.getChannel()).rejects.toThrow('Channel creation failed');
    });
  ...
  describe('integration scenarios', () => {
    ...
    it('should reconnect after connection failure', async () => {
      ...
      (amqp.connect as any).mockRejectedValueOnce(new Error('First attempt failed'));
      

      (amqp.connect as any).mockResolvedValueOnce(mockConnection);

      await expect(rabbitMQ.getConnection()).rejects.toThrow('First attempt failed');
